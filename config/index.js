export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxf87148a8be38185b",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "e0288421de8dc2823e1a8bfc50120a3b",
  ...
  USERS: [
    {
      ...
      id: "oGam45spN3ssBM0F-CfoDP-krUXQ",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "kIXnb6Rt9VzNfJYWpsUt2JHKclvHPboNllWu1dcOfiY",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "广州",
      ...
      festivals: [
        ...
        {"type": "节日", "name": "恋爱纪念日", "year": "2018", "date": "10-13"},
 ...
 //     name: "宝贝群群",
  ...
  CALLBACK_TEMPLATE_ID: "JSWdD-E-HUucwa9lTD4zCgeqG9U3g7QoR48sXWj4oiE",
